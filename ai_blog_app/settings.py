...
SECRET_KEY = 'django-insecure-v=8xsl6zp(6cr*kp$$hfd%s8l@fa#x_&sq^ghtlq@g&al@g9(l'
...
INSTALLED_APPS = [
    ...
    'blog_generator',  # Custom app for blog generation
]
...
TEMPLATES = [
    {
        ...
        # Ensure that the templates directory is included
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
